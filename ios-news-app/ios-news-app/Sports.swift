...
class Sports: UITableViewController, IndicatorInfoProvider {
    ...
    override func tableView(_ tableView: UITableView, contextMenuConfigurationForRowAt indexPath: IndexPath, point: CGPoint) -> UIContextMenuConfiguration? {
        ...
        let share = UIAction(title: "Share with Twitter", image: UIImage(named: "twitter")) {_ in
            ...
            let shareURL = "https://twitter.com/intent/tweet?text=\(text)&url=\(self.sportsArticles[index].url)&hashtags=CSCI_571_NewsApp"
        ...
        let bookmark = UIAction(title: "Bookmark", image: UIImage(systemName: "bookmark")) {_ in
            print("bookmarking" + self.sportsArticles[index].id)
        }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let index: Int = indexPath.row
        self.articleID = sportsArticles[index].id
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let guardianURL = "http://localhost:5000/guardian-sport"
